...
$GLOBALS['TL_JQUERY_VERSIONS'] = array(
	...
	'1.10.1' => array(
		'local' => 'assets/jquery-switcher/jquery-1.10.1.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.10.1.min.js',
	),
	'1.9.1' => array(
		'local' => 'assets/jquery-switcher/jquery-1.9.1.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.9.1.min.js',
	),
	'1.8.3' => array(
		'local' => 'assets/jquery-switcher/jquery-1.8.3.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.8.3.min.js',
	),
	'1.7.2' => array(
		'local' => 'assets/jquery-switcher/jquery-1.7.2.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.7.2.min.js',
	),
	'1.6.4' => array(
		'local' => 'assets/jquery-switcher/jquery-1.6.4.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.6.4.min.js',
	),
	'1.5.2' => array(
		'local' => 'assets/jquery-switcher/jquery-1.5.2.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.5.2.min.js',
	),
	'1.4.4' => array(
		'local' => 'assets/jquery-switcher/jquery-1.4.4.min.js|static',
		'googleapis' => 'http://code.jquery.com/jquery-1.4.4.min.js',
	),
	'1.3.2' => array(
		'local' => 'assets/jquery-switcher/jquery-1.3.2.min.js|static',
